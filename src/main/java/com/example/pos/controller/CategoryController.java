...
public class CategoryController {
    ...
    /**
     * Get list of categories with pagination, search, and filtering
     * Only accessible by ADMIN role
     *
     * @param page Page number (default: 0)
     * @param size Page size (default: 10)
     * @param search Search term for category name or slug (optional)
     * @param status Filter by status (optional)
     * @param sortBy Sort field (default: createdAt)
     * @param sortDir Sort direction: asc or desc (default: desc)
     * @return CategoryListResponse with pagination info
     */
    @GetMapping
    ...
    public ResponseEntity<CategoryListResponse> getCategories(
        ...
        CategoryListResponse response = categoryService.getCategories(page, size, search, status, sortBy, sortDir);
     ...
     * Only accessible by ADMIN role
     *
     * @param request CreateCategoryRequest with name and optional slug
     * @return CategoryDTO of created category with 201 Created status
     */
    @PostMapping
    @PreAuthorize("hasRole('ADMIN')")
     ...
     * @param request UpdateCategoryRequest with name, slug, status
